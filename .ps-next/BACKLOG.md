...
## Done
- [1] [x] Lifecycle status/footer projection convergence — Make /pi-next auto's status and footer a faithful typed projection of the shared lifecycle scheduler's disposition (idle/completed/budget-yield/blocked) instead of collapsing states into "stopped". (2026-08-26)
