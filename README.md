...
> **Experimental / pre-1.0:** v0.1.2 is the first migration-ready public
...
```sh
pi install -l git:github.com/niclas-lindgren/pi-next@v0.1.2
```
...
A commit SHA may be used while developing. v0.1.2 uses package/config schema
